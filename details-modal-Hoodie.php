<div class="modal fade details-6" id="details-6" tableindex="-6" role="dialog" aria-labelledby="details-6" area-hidden="true" >
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="center-block">
                  <img src="images/hoodie.jpg" alt="Levis Jeans" class="details img-responsive" />
                </div>
              </div>
                <div class="col-sm-6">
                  <h4>Details</h4>
