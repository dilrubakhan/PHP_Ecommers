<div class="modal fade details-2" id="details-4" tableindex="-2" role="dialog" aria-labelledby="details-1" area-hidden="true" >
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="center-block">
                  <img src="images/polo_shirt.jpg" alt="Levis Jeans" class="details img-responsive" />
                </div>
              </div>
                <div class="col-sm-6">
                  <h4>Details</h4>
