<div class="modal fade details-7" id="details-7" tableindex="-7" role="dialog" aria-labelledby="details-7" area-hidden="true" >
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="center-block">
                  <img src="images/headbands.jpg" alt="Levis Jeans" class="details img-responsive" />
                </div>
              </div>
                <div class="col-sm-6">
                  <h4>Details</h4>
